...
> outbound webhooks (6a–6h).** Thirteen experiments, each with a measured before
...
| 6 | [Async spine](docs/phases/06-async-spine.md) - Kafka, outbox, CDC, saga | 3 wk | next - 6a-6h done |
