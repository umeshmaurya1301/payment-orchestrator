...
| 09 | [Health-based routing](09-health-routing.md) | 5a-5b | Static routing sent a provider degraded to 80% errors **100%** of the traffic and success collapsed 99.7% -> 4.2%. Health-weighted routing moves it in **7s** and holds 97.5% -> 91.2%. Routing on health ALONE cost 5.8 points of steady-state success - "healthy" and "preferred" are different questions - and a generous half-open score produced a 12s oscillation |
