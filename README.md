...
> criteria all met (6a–6i).** Fourteen experiments, each with a measured before
...
| 6 | [Async spine](docs/phases/06-async-spine.md) - Kafka, outbox, CDC, saga | 3 wk | **criteria met** - saga remains |
